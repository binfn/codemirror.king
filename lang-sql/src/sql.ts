import {continuedIndent, indentNodeProp, foldNodeProp, LRLanguage, LanguageSupport} from "../../language/src/index.ts"
import {Extension} from "../../state/src/index.ts"
import {Completion} from "../../autocomplete/src/index.ts"
import {styleTags, tags as t} from "../../highlight/src/highlight.ts"
import {parser as baseParser} from "./sql.grammar"
import {tokens, Dialect, tokensFor, SQLKeywords, SQLTypes, dialect} from "./tokens.ts"
import {completeFromSchema, completeKeywords} from "./complete.ts"
