import {EditorView, ViewPlugin, ViewUpdate, Command, Decoration, DecorationSet,
        runScopeHandlers, KeyBinding} from "../../view/src/index.ts"
import {EditorState, StateField, StateEffect, EditorSelection, StateCommand, Prec,
        Facet, Extension} from "../../state/src/index.ts"
import {PanelConstructor, showPanel, Panel, getPanel} from "../../panel/src/panel.ts"
import {Text} from "../../text/src/index.ts"
import {RangeSetBuilder} from "../../rangeset/src/rangeset.ts"
import elt from "../../crelt/index.es.js"
import {SearchCursor} from "./cursor.ts"
import {RegExpCursor, validRegExp} from "./regexp.ts"
import {gotoLine} from "./goto-line.ts"
import {selectNextOccurrence} from "./selection-match.ts"

export {highlightSelectionMatches} from "./selection-match.ts"
