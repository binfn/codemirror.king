...
function domText(view) {
    ...
    function scan(node) {
        if (node.nodeType == 1) {
            if (node.nodeName == "BR" || node.contentEditable == "false")
                return;
            if (eol) {
                text += "\n";
                eol = false;
...
describe("EditorView drawing", () => {
    ...
    it("draws BR nodes on empty lines", () => {
        ...
        ist(!Array.from(cm.domAtPos(4).node.childNodes).some(n => n.nodeName == "BR"));
    });
    ...
    it("scrolls the selection into view when asked", () => {
        ...
        ist(box.top, pos === null || pos === void 0 ? void 0 : pos.top, "<=");
        ist(box.bottom, pos === null || pos === void 0 ? void 0 : pos.bottom, ">=");
    });
    it("can scroll ranges into view", () => {
        ...
        ist(box.top, top === null || top === void 0 ? void 0 : top.top, "<=");
        ist(box.bottom, bot === null || bot === void 0 ? void 0 : bot.bottom, ">=");
        cm.dispatch({ effects: EditorView.scrollIntoView(EditorSelection.range(300, 400)) });
        let pos400 = cm.coordsAtPos(400);
        ist(box.top, pos400 === null || pos400 === void 0 ? void 0 : pos400.top, "<=");
        ist(box.bottom, pos400 === null || pos400 === void 0 ? void 0 : pos400.bottom, ">=");
        cm.dispatch({ effects: EditorView.scrollIntoView(EditorSelection.range(150, 100)) });
        let pos100 = cm.coordsAtPos(100);
        ist(box.top, pos100 === null || pos100 === void 0 ? void 0 : pos100.top, "<=");
        ist(box.bottom, pos100 === null || pos100 === void 0 ? void 0 : pos100.bottom, ">=");
    });
    ...
    it("notices it is added to the DOM even if initially detached", () => {
        if (!window.IntersectionObserver)
            return; // Only works with intersection observer support
