import {ContentView, DOMPos, Dirty, noChildren, mergeChildrenInto} from "./contentview.ts"
import {DocView} from "./docview.ts"
import {TextView, MarkView, inlineDOMAtPos, joinInlineInto, coordsInChildren} from "./inlineview.ts"
import {clientRectsFor, Rect, clearAttributes} from "./dom.ts"
import {LineDecoration, WidgetType, BlockType} from "./decoration.ts"
import {Attrs, combineAttrs, attrsEq, updateAttrs} from "./attributes.ts"
import browser from "./browser.ts"
import {Text} from "../../state/src/index.ts"
...
export class LineView extends ContentView implements BlockView {
  ...
  length: number = 0
  declare dom: HTMLElement | null //TERMY
...
export class BlockWidgetView extends ContentView implements BlockView {
  declare dom: HTMLElement | null //TERMY
  declare parent: DocView | null //TERMY
  breakAfter = 0
