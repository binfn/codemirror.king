import {EditorState, Transaction, TransactionSpec, Extension, Prec, ChangeDesc,
        EditorSelection, SelectionRange, StateEffect, Facet} from "../../state/src/index.ts"
import {Line} from "../../text/src/index.ts"
import {StyleModule} from 'https://jspm.dev/style-mod';
type StyleSpec = {
  [propOrSelector: string]: string | number | StyleSpec | null
}
import {DocView} from "./docview.ts"
import {InputState} from "./input.ts"
import {Rect, focusPreventScroll, flattenRect, getRoot, ScrollStrategy} from "./dom.ts"
import {posAtCoords, moveByChar, moveToLineBoundary, byGroup, moveVertically, skipAtoms} from "./cursor.ts"
import {BlockInfo} from "./heightmap.ts"
import {ViewState} from "./viewstate.ts"
import {ViewUpdate, styleModule,
        ...
        scrollTo, centerOn, scrollIntoView, UpdateFlag, ScrollTarget} from "./extension.ts"
import {theme, darkTheme, buildTheme, baseThemeID, baseLightID, baseDarkID, lightDarkIDs, baseTheme} from "./theme.ts"
import {DOMObserver} from "./domobserver.ts"
import {Attrs, updateAttrs, combineAttrs} from "./attributes.ts"
import browser from "./browser.ts"
import {applyDOMChange} from "./domchange.ts"
import {computeOrder, trivialOrder, BidiSpan, Direction} from "./bidi.ts"
