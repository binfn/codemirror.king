import {Text, findClusterBreak} from "../../text/src/index.ts"
import {ChangeSet, ChangeSpec, DefaultSplit} from "./change.ts"
import {EditorSelection, SelectionRange, checkSelection} from "./selection.ts"
import {Transaction, TransactionSpec, resolveTransaction, asArray, StateEffect} from "./transaction.ts"
import {allowMultipleSelections, changeFilter, transactionFilter, transactionExtender,
        lineSeparator, languageData, readOnly} from "./extension.ts"
import {Configuration, Facet, Extension, StateField, SlotStatus, ensureAddr, getAddr, Compartment, DynamicSlot} from "./facet.ts"
import {CharCategory, makeCategorizer} from "./charcategory.ts"
