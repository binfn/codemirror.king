import {EditorView, Command, ViewPlugin, PluginValue, ViewUpdate, logException} from "../../view/src/index.ts"
import {Transaction} from "../../state/src/index.ts"
import {completionState, setSelectedEffect, startCompletionEffect, closeCompletionEffect, setActiveEffect, State,
        ActiveSource, ActiveResult, getUserEvent} from "./state.ts"
import {getTooltip, TooltipView} from "../../tooltip/src/tooltip.ts"
import {completionConfig} from "./config.ts"
import {cur, CompletionResult, CompletionContext, applyCompletion, ensureAnchor} from "./completion.ts"
