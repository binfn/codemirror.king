import {EditorView, ViewUpdate, Direction, logException} from "../../view/src/index.ts"
import {StateField, EditorState} from "../../state/src/index.ts"
import {TooltipView} from "../../tooltip/src/tooltip.ts"
import {CompletionState} from "./state.ts"
import {completionConfig, CompletionConfig} from "./config.ts"
import {Option, applyCompletion, Completion} from "./completion.ts"
