import {NodeProp, SyntaxNode, Tree} from "../../lezer/common/index.ts"
import {EditorState, Extension, Facet} from "../../state/src/index.ts"
import {countColumn} from "../../text/src/index.ts"
import {syntaxTree} from "./language.ts"
...
export function indentOnInput(): Extension {
  return EditorState.transactionFilter.of(tr => {
    ...
    if (!rules.some((r: { test: (arg0: any) => any; }) => r.test(lineStart))) return tr
