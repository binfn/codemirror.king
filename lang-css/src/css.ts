import {parser} from "../../lezer/css/parser.js"
import {LRLanguage, continuedIndent, indentNodeProp, foldNodeProp, foldInside, LanguageSupport} from "../../language/src/index.ts"
import {styleTags, tags as t} from "../../highlight/src/highlight.ts"
import {Extension} from "../../state/src/index.ts"
import {cssCompletionSource} from "./complete.ts"
export {cssCompletionSource} from "./complete.ts"
